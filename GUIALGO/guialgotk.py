...
class Toplevel1:
    ...
    def UpdateButton(self):
        ...
        print(orderside)
        ordertype = "MARKET"
        order_average_traded_price = self.textorderaveragetradedprice.get(
            "1.0", 'end-1c')
        try:
            orderquantity = int(self.textorderquantity.get("1.0", 'end-1c'))
        except Exception:
            messagebox.showerror(
                "Input Error", "Please provide valid Order quantity")
            return
        timeInForce = "DAY"
        disclosedQuantity = 0
        limitPrice = 0
    ...
    def __init__(self, top=None):
        ...
        self.Frame2.place(relx=0.05, rely=0.050,
                          relheight=0.85, relwidth=0.888)
        ...
        self.textclient = OptionMenu(self.Frame2, self.var_client, *clientlist)
        ...
        self.textexchangesegment = OptionMenu(
            self.Frame2, self.seg_var, "NSECM", "NSEFO", "NSECD", "MCXFO")
        self.textexchangesegment.place(
            relx=0.504, rely=0.24, height=24, width=200)
        # print(seg_var)
        ...
        for side in sides:
            tk.Radiobutton(self.Frame2,
                           ...
                           value=side).place(relx=relx, rely=0.650, relheight=0.056, relwidth=0.16)
            relx += 0.170
        ...
        self.textorderquantity.place(
            relx=0.504, rely=0.792, height=24, width=200)
        ...
        self.orderaveragetradedprice.place(
            relx=0.142, rely=0.860, height=60, width=150)
        ...
        self.orderaveragetradedprice.configure(
            text='''Order Average \nTraded Price''')

        self.textorderaveragetradedprice = tk.Text(self.Frame2)
        self.textorderaveragetradedprice.place(
            relx=0.504, rely=0.890, height=24, width=200)
