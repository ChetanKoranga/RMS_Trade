...
const toggle = [
  ...
  { key: "c", text: "RESTART", value: "START" },
];
...
class Forms extends Component {
  ...
  finishInfraday(){
    this.setState({showModal:true,
      Status:"finishinfraday" })
    
  }

  finishOvernight(){
    this.setState({showModal:true,
      Status:"finishovernight" })
  }
  

  restartInfraday(){
    this.setState({showModal:true,
      Status:"restartinfraday" })
    
  }

  restartOvernight(){
    this.setState({showModal:true,
      Status:"restartovernight" })
    ...
    return (
      <div className="container">
        ...
        <Form>
            ...
            <ButtonToolbar>
              <Button color="blue" onClick={this.handleSubmit}>
                ...
                <Alert
                  ...
                  style={{ flexWrap: "wrap", textAlign: "centre" , wordWrap:"break-word"}}
                >
          ...
          <Form.Group>
          <Button color="black" onClick={this.finishInfraday}>
            FINISH INTRADAY
          </Button>
          <Button color="black" onClick={this.restartInfraday}>
            RESTART INTRADAY
          </Button>
          <Button color="black" onClick={this.finishOvernight}>
            FINISH OVERNIGHT
          </Button>
          <Button color="black" onClick={this.restartOvernight}>
            RESTART OVERNIGHT
          </Button>
          <AddModal
